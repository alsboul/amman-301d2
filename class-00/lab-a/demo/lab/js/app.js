...
function displayPics(){
  ...
  //When we use the consol log outside the function they give me an error becuse let need to define things inside it and var we can call any thing with var whenever we want.
  console.log(viewed);
